...
histogram <- shapeDef("A histogram shape rendered by FM synthesis; only 'pitch' is actually available for mapping, the remainder of sound parameters are only available to set",
                      "csound", list(), c(time, pitch, dur, vol, pan, tempo,
                                attkp, decayp, mod, indx))
