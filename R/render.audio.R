...
##' @rdname render.audio
##' @method audio_layer scatter
audio_layer.scatter <- function(sonlayerscore, out, samp.rate, ...) {
...
.createNoteAudio <- function(noterow, samp.rate) {
  ...
  ## "noterow" is intended to be what is returned by a row from funciton df.scatter
